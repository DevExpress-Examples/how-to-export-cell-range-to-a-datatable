...
'			Me.barButtonItemRangeToDataTable.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItemRangeToDataTable_ItemClick);
			' 
...
'			Me.barButtonItemUseExporterOptions.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItemUseExporterOptions_ItemClick);
			' 
			' fileRibbonPage1
			' 
